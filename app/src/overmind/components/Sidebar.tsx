...
const OvermindSidebar: React.FC<{ demoMode: boolean, newMenuButton?: Partial<React.Component>[] }> = props => {
    ...
    return <div className="sidebar">
        {props.demoMode ?? <div className="menu">
        ...
        <div className="menu">
            <Button className={`p-button-link ${location.pathname.match(props.demoMode ? /^\/workspaces/g : /^\/$/g) ? 'active' : null}`} onClick={() => history.push(props.demoMode ? '/workspaces' : '/')}>
        ...
        {props.demoMode ?? <><div className="download">
