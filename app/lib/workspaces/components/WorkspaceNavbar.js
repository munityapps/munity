...
var WorkspaceNavbar = function (props) {
    var menu = useRef(null);
    var dispatch = useAppDispatch();
    var location = useLocation();
    var history = useHistory();
    return _jsxs("div", __assign({ className: "navbar" }, { children: [_jsxs("div", __assign({ className: "left-part p-d-flex p-ai-center" }, { children: [_jsx(Button, __assign({ onClick: function () { return history.push('/'); }, className: "p-button-link" }, { children: _jsx("img", { src: logo, alt: "logo" }, void 0) }), void 0), _jsx("div", __assign({ className: "workspace-name" }, { children: props.workspace }), void 0)] }), void 0), _jsxs("div", __assign({ className: "middle-part" }, { children: [_jsx(Button, __assign({ onClick: function () { return history.push("/workspace/" + props.workspace + "/users"); }, className: "p-button-link " + (location.pathname.match(/^\/workspace\/[^/]+\/users/g) ? ' active' : '') }, { children: "Users" }), void 0), _jsx(Button, __assign({ onClick: function () { return history.push("/workspace/" + props.workspace + "/groups"); }, className: "p-button-link " + (location.pathname.match(/^\/workspace\/[^/]+\/groups/g) ? ' active' : '') }, { children: "Groups" }), void 0)] }), void 0), _jsxs("div", __assign({ className: "right-part" }, { children: [_jsx(Button, __assign({ className: "p-button-link" }, { children: _jsx(FontAwesomeIcon, { icon: faQuestionCircle }, void 0) }), void 0), _jsx(Button, __assign({ className: "p-button-link" }, { children: _jsx(FontAwesomeIcon, { icon: faBell }, void 0) }), void 0), _jsxs("div", __assign({ className: "hi-message" }, { children: ["Salut,\u00A0", _jsx("strong", { children: "Patrick" }, void 0)] }), void 0), _jsx(Avatar, { shape: "circle", image: avatar }, void 0), _jsx(Menu, { model: [
                            {
                                label: 'Mon profile',
